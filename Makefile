...
.PHONY: help bootstrap preflight dns concourse argocd istio kiali credentials login secrets warm pipelines access open status focal-invitations slates-identities check
